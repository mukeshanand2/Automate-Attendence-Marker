...
haarcasecade_path = cwd + "/haarcascade_frontalface_default.xml"
trainimagelabel_path = (
    cwd + "/TrainingImageLabel/Trainner.yml"
)
trainimage_path = cwd + "/TrainingImage"
studentdetail_path = (
    cwd + "/StudentDetails/studentdetails.csv"
)
attendance_path = cwd + "/Attendance"
